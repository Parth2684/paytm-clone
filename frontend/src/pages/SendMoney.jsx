                ...
                <div className="p-6">
                    <div className="flex items-center space-x-4">
                        <div className="w-12 h-12 rounded-full bg-green-500 flex items-center justify-center">
                            <span className="text-2xl text-white">Parth</span>
                        </div>
                        <h3 className="text-2xl font-semibold">Parth Bhosle</h3>
                    </div>
                    <div className="space-y-4">
                        ...
                        <button className="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-4 w-full bg-green-500 text-white">
                            Initiate Transfer
                        </button>
                    </div>
                </div>
